      ...
      <div className="w-full max-w-3xl">
        <div className="text-center mb-4">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Información estratégica y análisis
          </p>
        </div>

        <div className="bg-white rounded-md shadow-lg p-4">
          <p className="text-sm text-gray-700 mb-4">
            El módulo de Reportes permitirá generar informes y análisis
            detallados sobre diferentes aspectos del sistema. Podrás exportar
            los datos para análisis externo.
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className="flex items-start gap-2 p-3 bg-green-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-0.5">
                  Estadísticas por período, cliente, producto.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-0.5">
                  Stock actual, movimientos y alertas.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2 p-3 bg-amber-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 mt-0.5">
                  Ingresos, ganancias, por cobrar y pagar.
                </p>
              </div>
            </div>
