...
import { Box, Loader2, Database, CheckCircle, XCircle, Building2, User, Lock } from 'lucide-react';
          ...
          <div className="p-4">
            ...
            <div className="space-y-5">
              ...
              <Button
                ...
                disabled={loadingRegister || loadingConexiones || !baseDatos || !idDependencia}
                className="w-full"
              >
                {loadingRegister ? (
