    ...
    try {
      if (editingId) {
        const data: SolicitudServicioUpdate = {
          ...
          material_asumido_x:
            formData.material_asumido_x === "true" ||
            formData.material_asumido_x === true,
    ...
    try {
      if (aprobarModal.modo === "crear") {
        ...
        const data: ContratoCreate = {
          ...
          vigencia:
            formContrato.vigencia || new Date().toISOString().split("T")[0],
        ...
        await solicitudesService.updateSolicitud(
          aprobarModal.solicitud.id_solicitud_servicio,
          {
            aprobado: true,
        ...
        const contratoSeleccionado = aprobarModal.contratos.find(
          (c) =>
            c.id_contrato === Number(formContrato.id_contrato_seleccionado),
        );
            ...
            <TableBody>
              {filteredSolicitudes.length === 0 ? (
                ...
                filteredSolicitudes.map((item) => (
                  <TableRow
                    key={item.id_solicitud_servicio}
                  ...
                  >
                    ...
                    <TableCell onClick={(e) => e.stopPropagation()}>
                      {item.id_contrato ? (
                        <Button
                          ...
                          onClick={() =>
                            item.id_contrato &&
                            openContratoModal(item.id_contrato)
                          }
                    ...
                    <TableCell onClick={(e) => e.stopPropagation()}>
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/proyectos/etapas?solicitud=${item.id_solicitud_servicio}`,
                          )
                        }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input
                ...
                onChange={(e: any) =>
                  setFormData({ ...formData, fecha_solicitud: e.target.value })
                }
                className="mt-1"
              />
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e: any) =>
                  setFormData({ ...formData, nombres_rep: e.target.value })
                }
                className="mt-1"
            ...
            <div>
              ...
              <Input
                value={formData.apellido1_rep || ""}
                onChange={(e: any) =>
                  setFormData({ ...formData, apellido1_rep: e.target.value })
                }
                className="mt-1"
            ...
            <div>
              ...
              <Input
                value={formData.apellido2_rep || ""}
                onChange={(e: any) =>
                  setFormData({ ...formData, apellido2_rep: e.target.value })
                }
                className="mt-1"
            ...
            <div>
              ...
              <Input
                value={formData.ci_rep || ""}
                onChange={(e: any) =>
                  setFormData({ ...formData, ci_rep: e.target.value })
                }
                className="mt-1"
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e: any) =>
                  setFormData({ ...formData, telefono_rep: e.target.value })
                }
                className="mt-1"
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-auto animate-scale-in">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-gray-900">
                        {detailModal.item.codigo_solicitud || "Sin código"}
                      </h3>
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-teal-50 to-cyan-50 p-4 rounded-xl border border-teal-100">
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                        detailModal.item.estado === "TERMINADA"
                          ? "bg-green-100 text-green-800"
                          : detailModal.item.estado === "CANCELADA"
                            ? "bg-red-100 text-red-800"
                            : detailModal.item.estado === "EN PROCESO"
                              ? "bg-blue-100 text-blue-800"
                              : detailModal.item.estado === "EN NEGOCIACION"
                                ? "bg-purple-100 text-purple-800"
                                : "bg-yellow-100 text-yellow-800"
                      }`}
                    >
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl border border-green-100">
                    ...
                    <p className="font-bold text-gray-900">
                      {detailModal.item.aprobado ? "Sí" : "No"}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl">
                    ...
                    <p className="font-bold text-gray-900">
                      {detailModal.item.fecha_solicitud || "N/A"}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-xl">
                    <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">
                    ...
                    <p className="font-bold text-gray-900">
                      {detailModal.item.fecha_entrega || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-4 rounded-xl">
                    ...
                    <p className="font-bold text-gray-900">
                      {detailModal.item.cargo || "N/A"}
                    </p>
                  </div>
                </div>
                {(detailModal.item.nombres_rep ||
                  detailModal.item.apellido1_rep) && (
                  <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-100">
                    ...
                    <p className="font-bold text-gray-900">
                      {[
                        detailModal.item.nombres_rep,
                        detailModal.item.apellido1_rep,
                        detailModal.item.apellido2_rep,
                      ]
                        .filter(Boolean)
                        .join(" ")}
                    </p>
                    {detailModal.item.ci_rep && (
                      <p className="text-sm text-gray-600 mt-1">
                        CI: {detailModal.item.ci_rep}
                      </p>
                    )}
                    {detailModal.item.telefono_rep && (
                      <p className="text-sm text-gray-600 mt-1">
                        Tel: {detailModal.item.telefono_rep}
                      </p>
                    )}
                  </div>
                )}
              ...
              <div className="p-6 border-t border-gray-200 bg-gray-50 flex justify-end gap-3">
                <button
                  onClick={() =>
                    navigate(
                      `/proyectos/etapas?solicitud=${detailModal.item!.id_solicitud_servicio}`,
                    )
                  }
                  className="px-6 py-3 text-white bg-gradient-to-r from-teal-500 to-cyan-600 rounded-xl hover:from-teal-600 hover:to-cyan-700 transition-colors font-medium"
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {contratoModal.item?.nombre || "Cargando..."}
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="p-6 space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl">
                      ...
                      <p className="font-bold text-gray-900">
                        {contratoModal.item.cliente?.nombre || "N/A"}
                      </p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl">
                      <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">
                      ...
                      <p className="font-bold text-gray-900">
                        ${Number(contratoModal.item.monto).toFixed(2)}
                      </p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl">
                      <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">
                      ...
                      <p className="font-bold text-gray-900">
                        {contratoModal.item.estado?.nombre || "N/A"}
                      </p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-xl">
                      <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl">
                      ...
                      <p className="font-bold text-gray-900">
                        {contratoModal.item.vigencia || "N/A"}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-auto animate-scale-in">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {aprobarModal.solicitud?.codigo_solicitud ||
                          "Sin código"}
                      </p>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e: any) =>
                            setFormContrato({
                              ...formContrato,
                              id_contrato_seleccionado: e.target.value,
                            })
                          }
                        >
              ...
              <div className="p-6 border-t border-gray-200 bg-gray-50 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-3 text-white bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl hover:from-green-600 hover:to-emerald-700 transition-colors font-medium"
                >
