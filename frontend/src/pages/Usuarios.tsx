      ...
      <div className="space-y-4 animate-fade-in-up">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-green-500 to-emerald-600 rounded shadow-lg">
            ...
            >
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setUsuarioForm({ ...usuarioForm, ci: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setUsuarioForm({
                      ...usuarioForm,
                      id_grupo: parseInt(e.target.value),
                    })
                  }
                >
  ...
  const content = (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-br from-green-500 to-emerald-600 rounded shadow-lg animate-bounce-subtle">
            <Users className="h-5 w-5 text-white" />
          </div>
          <div className="flex items-baseline">
        ...
        <Button
          ...
          className="gap-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-300"
        >
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="flex items-center justify-between p-4 border-b">
              ...
              <Button
                ...
                size="icon"
                onClick={() =>
                  setCreatedUserModal({ ...createdUserModal, isOpen: false })
                }
              >
                <X className="h-5 w-5" />
              </Button>
            ...
            <div className="p-6 space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-sm text-green-800 mb-2">
                  El usuario ha sido creado con las siguientes credenciales
                  autogeneradas:
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="text-lg font-medium">
                    {createdUserModal.usuario.nombre}{" "}
                    {createdUserModal.usuario.primer_apellido}{" "}
                    {createdUserModal.usuario.segundo_apellido || ""}
                  </div>
                </div>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (createdUserModal.usuario!.password_temporal) {
                            navigator.clipboard.writeText(
                              createdUserModal.usuario!.password_temporal!,
                            );
                ...
                <p className="text-sm text-yellow-700 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  ⚠️ Esta información solo se muestra una vez. Asegúrese de
                  copiar la contraseña antes de cerrar.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold">
                    {detailModal.usuario.nombre}{" "}
                    {detailModal.usuario.primer_apellido}{" "}
                    {detailModal.usuario.segundo_apellido || ""}
                  </h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="font-medium">
                    {detailModal.usuario.grupo?.nombre || "-"}
                  </div>
                </div>
                <div className="col-span-2">
                  <Label className="text-gray-600">Dependencia</Label>
                  <div className="font-medium">
                    {detailModal.usuario.dependencia?.nombre ||
                      "Sin dependencia"}
                  </div>
                </div>
              </div>
