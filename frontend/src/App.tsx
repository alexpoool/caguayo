...
const rutasPorModulo: Record<Modulo, string[]> = {
  ...
  proyecto: [
    ...
    "/proyectos/etapas",
    "/proyectos/tareas-etapa",
    "/proyectos/creadores",
    "/proyectos/facturas-servicio",
    "/proyectos/pagos-factura-servicio",
    "/proyectos/liquidaciones",
  ],
  reportes: ["/reportes"],
  home: ["/"],
};
              ...
              <Routes>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/servicios"
                    >
                      <ServiciosPage />
                    </ProtectedRoute>
                  }
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/solicitudes"
                    >
                      <SolicitudesPage />
                    </ProtectedRoute>
                  }
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/tareas-etapa"
                    >
                      <TareasEtapaPage />
                    </ProtectedRoute>
                  }
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/creadores"
                    >
                      <CreadoresPage />
                    </ProtectedRoute>
                  }
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/facturas-servicio"
                    >
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/pagos-factura-servicio"
                    >
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/proyectos/liquidaciones"
                    >
                ...
                />
                <Route
                  path="/reportes/proveedores-dependencia"
                  element={
                    <ProtectedRoute
                      moduloActivo={moduloActivo}
                      currentPath="/reportes/proveedores-dependencia"
                    >
                      <ReporteProveedores />
                    </ProtectedRoute>
                  }
