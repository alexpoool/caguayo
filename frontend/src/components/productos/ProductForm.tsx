...
export function ProductForm({
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setFormData({
        ...
        punto_pedido: initialData.punto_pedido || 0,
        lead_time_dias: initialData.lead_time_dias || 0,
        clasificacion_abc: initialData.clasificacion_abc || "",
      });
    } else {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const dataToSubmit = {
      ...
      punto_pedido: formData.punto_pedido || 0,
      lead_time_dias: formData.lead_time_dias || 0,
      clasificacion_abc: formData.clasificacion_abc || undefined, // undefined en lugar de null
    };
  ...
  const isLoading =
    isLoadingCategorias || isLoadingSubcategorias || isLoadingMonedas;
    ...
    <Card className="overflow-hidden">
      ...
      <CardContent className="p-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  handleCategoriaChange(parseInt(e.target.value) || 0)
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    id_subcategoria: parseInt(e.target.value) || 0,
                  })
                }
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  required
                  value={
                    formData.precio_compra === 0 ? "" : formData.precio_compra
                  }
                  onChange={(e) =>
                    handleNumberInputChange("precio_compra", e.target.value)
                  }
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  required
                  value={
                    formData.precio_venta === 0 ? "" : formData.precio_venta
                  }
                  onChange={(e) =>
                    handleNumberInputChange("precio_venta", e.target.value)
                  }
                  className="flex-1 h-11"
                  placeholder="0.00"
                />
            ...
            <div>
              ...
              <Input
                ...
                required
                value={
                  formData.precio_minimo === 0 ? "" : formData.precio_minimo
                }
                onChange={(e) =>
                  handleNumberInputChange("precio_minimo", e.target.value)
                }
                className="h-11"
                placeholder="0.00"
              />
          ...
          <h3 className="text-sm font-bold text-gray-700 pt-2 border-t">
            Planificación de Stock
          </h3>

          {/* Fila de Reposición de Stock */}
          <div className="grid grid-cols-4 gap-4">
            <div>
              <Label
                className="text-sm mb-1.5 block"
                title="Umbral de Alertas (ROP)"
              >
                Punto de Pedido
              </Label>
              <Input
                type="number"
                required
                value={formData.punto_pedido === 0 ? "" : formData.punto_pedido}
                onChange={(e) =>
                  handleNumberInputChange("punto_pedido", e.target.value)
                }
                className="h-11"
                placeholder="0"
              />
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNumberInputChange("stock_minimo", e.target.value)
                }
                className="h-11"
                placeholder="0"
              />
            ...
            <div>
              <Label className="text-sm mb-1.5 block">Lead Time (Días)</Label>
              <Input
                type="number"
                required
                value={
                  formData.lead_time_dias === 0 ? "" : formData.lead_time_dias
                }
                onChange={(e) =>
                  handleNumberInputChange("lead_time_dias", e.target.value)
                }
                className="h-11"
                placeholder="Días"
              />
            ...
            <div>
              <Label className="text-sm mb-1.5 block">Clasificación ABC</Label>
              <select
                value={formData.clasificacion_abc || ""}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    clasificacion_abc: e.target.value,
                  })
                }
                className="w-full px-3 py-2 h-11 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-white"
              >
