...
class TipoCuentaServiceClass(
    GenericService[TipoCuenta, TipoCuentaCreate, TipoCuentaUpdate, TipoCuentaRead]
):
    pass


tipo_cuenta_service = TipoCuentaServiceClass(
    repository=tipo_cuenta_repo, read_schema=TipoCuentaRead, model_name="Tipo de Cuenta"
)
